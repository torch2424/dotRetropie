///////////////////////////////////////////////////
//
// Attract-Mode Frontend - "conveyor davbarc" module
//
///////////////////////////////////////////////////
...
class Conveyor
{
	...
	//
	stride					= 10;		// must be 1 or greater
...
//
//    local bkgsolid = SimpleArtStrip( "snap", 5, 0, 0,
...
// SimpleArtStripSlot class - used by SimpleArtStrip
///////////////////////////////////////////////////
class SimpleArtStripSlotB extends ConveyorSlot
{
	m_p=null;
	constructor( parent, artname )
	{
		m_p=parent;
		base.constructor( ::fe.add_image( artname ) );
	}
...
class SimpleArtStripB extends Conveyor
{
	m_x=0; m_y=0; m_width=0; m_height=0; m_x_span=0; m_y_span=0;
	...
	constructor( artwork_label, num_objs, x, y, width, height, pad=0 )
	{
		...
		local my_list = [];
		for ( local i=0; i<num_objs; i++ )
			my_list.push( SimpleArtStripSlotB(this,artwork_label) );
		set_slots( my_list );
...
// SimpleArtStripSlot class - used by SimpleArtStrip
///////////////////////////////////////////////////
class SimpleArtStripSlotMini extends ConveyorSlot
{
	m_p=null;
	constructor( parent, artname )
	{
...
class SimpleArtStripMini extends Conveyor
{
	m_x=0; m_y=0; m_width=0; m_height=0; m_x_span=0; m_y_span=0;
	...
	constructor( artwork_label, num_objs, x, y, width, height, pad=0 )
	{
		...
		local my_list = [];
		for ( local i=0; i<num_objs; i++ )
			my_list.push( SimpleArtStripSlotMini(this,artwork_label) );
		set_slots( my_list );
