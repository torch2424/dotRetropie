...
class UserConfig {
   </ label="Select bg image or panscan", help="Select bg image or panscan art(flyer)", options="bkg_console", order=1 /> enable_image="bkg_console";   
   </ label="Select cab skin", help="Select a cab skin image", options="cab_console", order=2 /> enable_cab="cab_console";
...
if ( my_config["enable_image"] == "bkg_console") 
{
local bg = fe.add_image( "bkg_consoleroom.png", 0, 0, flw, flh );
bg.alpha=255;
}
...
{
	snapbg = fe.add_image("static.mp4", flx*0.272, fly*0.278, flw*0.14, flh*0.17 );
...
surface.set_pos(flx*0.272, fly*0.278, flw*0.14, flh*0.17);
   ...
   if ( my_config["enable_Lmarquee"] == "Yes" )
{
 ...
 {
 local clogos = fe.add_image("clogos/[Emulator]", flx*0.045, fly*0.055, flw*0.142, flh*0.085 );
...
//cabinet image
if ( my_config["enable_cab"] == "cab_console" )
{
 local cab = fe.add_image( "cab_console.png", 0, 0, flw, flh );
}
