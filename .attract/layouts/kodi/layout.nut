...
class UserConfig {
   ...
   </ label="Select background image", help="Select theme background or flyer", options="default,flyer", order=2 /> enable_bg="default";   
   </ label="Select cabinet image", help="Select a cab skin image", options="default", order=3 /> enable_cab="default";
   </ label="Select listbox, wheel, vert_wheel", help="Select wheel type or listbox", options="listbox, wheel, vert_wheel", order=4 /> enable_list_type="vert_wheel";
   ...
   </ label="Enable box art", help="Select box art", options="Yes,No", order=8 /> enable_gboxart="Yes"; 
   </ label="Enable cartridge art", help="Select cartridge art", options="Yes,No", order=9 /> enable_gcartart="Yes"; 
...
{
local marquee = fe.add_artwork("marquee", flx*0.1, fly*0.05, flw*0.2, flh*0.1 );
...
{
 local clogos = fe.add_image("clogos/[Emulator]", flx*0.03, fly*0.03, flw*0.2, flh*0.1 );
 clogos.trigger = Transition.EndNavigation;
 clogos.skew_y = 0;
 clogos.skew_x = 0;
 clogos.pinch_x = 0;
